...
define(function(require, exports) {
  ...
  syn(ast.Script, "globalDecls", function() {
    return this.collectDecls([]);
  });
  syn(ast.Program, "globalDecls", function() {
    var res = [];
    this.scripts.forEach(function(script) {
      script.globalDecls().forEach(function(decl) {
        res[res.length] = decl;
      });
    });
    return res; 
  ...
  ast.ParameterDeclaration.prototype.isGlobal = function() {
    return !this.getEnclosingFunction();
  };
  
  ast.FunctionDeclaration.prototype.isGlobal = function() {
    return !this.getEnclosingFunction();
  };
});