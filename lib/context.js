/**
 * The normalizer uses contexts to keep track of four bits of information:
 * 
 *   * the current name binding scope
 *   * the current target variable
 *   * the set of generated temporary variables
 *   * the labels to which a break/continue would refer in the current scope
 */
...
define(function(require, exports) {
  ...
  Context.prototype.setTarget = function(trg) {
    this.targets[this.targets.length-1] = trg;
  };
