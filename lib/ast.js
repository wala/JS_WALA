...
define(function(require, exports) {
  ...
  defnode("CatchClause", [ "param:ParamDecl", "body:BlockStatement" ]);

  defnode("ParamDecl", [ "name:<String>" ], "Identifier");
  ...
  var FunctionExpression = defnode("FunctionExpression", "Expression", [ "name:<String>?", "params:ParamDecl*", "body:BlockStatement" ]);
  ...
  var FunctionDeclaration = defnode("FunctionDeclaration", "Statement", [ "name:<String>", "params:ParamDecl*", "body:BlockStatement" ]);
