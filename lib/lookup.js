...
define(function(require, exports) {
  ...
  function inh(parent_type, child_name, attr_name, fn) {
    ...
    if(!ast.Node.prototype[attr_name]) {
      ast.Node.prototype[attr_name] = function() {
        ...
        if(this[cache_field_name][key])
          return this[cache_field_name][key];
        return this[cache_field_name][key] = this[compute_method_name](this.childIndex, arguments);
      };
  ...
  syn(ast.FunctionDeclaration, "localDecls", function() { return this.collectDecls([]); });
  syn(ast.FunctionExpression, "localDecls", function() { return this.collectDecls([]); });
  ...
  ast.Var.prototype.decl = function() {
    debugger;
  ...
  ast.VariableDeclarator.prototype.isGlobal = function() {
    return !!(this.getEnclosing(ast.FunctionDeclaration) || this.getEnclosing(ast.FunctionExpression));
  };
});