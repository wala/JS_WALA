/**
 * Convenience functions for constructing Esprima ASTs.
 */
...
define(function(require, exports) {
  function defconstructor(tpname, children) {
    var child_names = [], nonterminal_children = [];
    for(var i=0;i<children.length;++i)
      if(children[i][0] === '<') {
        child_names[child_names.length] = children[i].substring(1, children[i].length-1);
      } else {
        child_names[child_names.length] = children[i];
        nonterminal_children[nonterminal_children.length] = children[i];
      }
  ...
  // constructors are defined from this table
  var children = {
