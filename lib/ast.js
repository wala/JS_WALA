...
define(function(require, exports) {
  ...
  Node.prototype.getLastChild = function() { return this.getChild(this.getNumChild()-1); };
  ...
  List.prototype.unshift = function(elts) {
    var num_elts = elts instanceof List ? elts.length : 1;
    if(num_elts > 0) {
      for(var i=this.length-1;i>=0;--i)
        this.setChild(i+num_elts, this.getChild(i));
      if(elts instanceof List)
        for(i=0;i<num_elts;++i)
          this.setChild(i, elts.getChild(i));
      else
        this.setChild(0, elts);
    }
  };
  List.prototype.push = function(elt) {
    this.setChild(this.length, elt);
    return this;
  };
  List.prototype.pushAll = function(elts) {
    for(var i=0;i<elts.length;++i)
      this.setChild(this.length, elts[i]);
    return this;
  };
  ...
  Node.prototype.dump = function() {
    ...
    for(var i=0;i<this.getNumChild();++i) {
      if(i > 0)
        res += ", ";
      res += this.getChild(i) && this.getChild(i).dump();
    }
    res += ")";
    return res;
  };
  ...
  exports.Var.prototype.dump = function() { return "Var(" + this.name + ")"; };
  exports.Literal.prototype.dump = function() { return "Literal(" + this.value + ")"; };
});